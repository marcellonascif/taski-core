...
export class TaskService {
    constructor(
        ...
        private readonly extractTask: ExtractTaskUseCase,
    ) {}
    ...
    async postExtract(extractTaskDto: ExtractTaskDto): Promise<any> {
        ...
        const prompts = {
            system: systemPrompt,
            user: extractTaskDto.prompt,
        };

        const response = await this.extractTask.execute(prompts);
